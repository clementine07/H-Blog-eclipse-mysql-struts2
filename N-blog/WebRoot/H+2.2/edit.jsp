...
<head>
    ...
    <title>素材火www.sucaihuo.com - 基本表单</title>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li class="active"><a href="form_basic.html">基本表单</a>
                            </li>
                            ...
                            <s:if test="null == blog">
                                <form  class="form-horizontal" action="Add" method="post">
                                	<div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                        	<s:textfield name="blog.id" />       
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" name="blog.title" >标题</label>
                                        <div class="col-sm-10">
                                ...
                                <form class="form-horizontal" action="Change" method="post">
                                	<div class="form-group">
                                        <label class="col-lg-2 control-label">编号</label>
                                        <div class="col-lg-10">
                                        	<s:textfield  disabled="" placeholder="blog.id"  class="form-control"/>          
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" name="blog.title" >标题</label>
