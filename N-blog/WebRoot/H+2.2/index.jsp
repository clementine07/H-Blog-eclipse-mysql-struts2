                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        ...
                        <div class="dropdown profile-element"> <span>
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="index.html#">
                                <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">${sessionScope.loginUserName }</strong>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="List">文章管理</a>
                            </li>
                            <li><a href="edit.jsp">增加文章</a>
                            </li>
